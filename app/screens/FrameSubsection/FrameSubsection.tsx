...
export default function FrameSubsection() {
  ...
  <Badge
        variant="secondary"
        className="inline-flex w-[120px] max-[1500px]:w-[104px] items-center gap-[8.53px] px-[17.83px] py-[9.3px] rounded-[4.65px] border-[1.55px] border-solid border-[#00000003] backdrop-blur-[17px] backdrop-brightness-[100%] bg-[linear-gradient(141deg,rgba(0,0,0,0.2)_0%,rgba(102,102,102,0.2)_100%)]"
      >
        <span className="font-medium text-black text-[14px] max-[1500px]:text-[12.4px] tracking-[0.50px]">
          Networking
        </span>
      </Badge>
      <h2 className="font-Roboto font-semibold text-black text-[60px] max-[1500px]:text-[53px] max-[1100px]:text-[48px] max-[1000px]:text-[36px] max-[767px]:text-[28px] tracking-[0.27px]">
        Trending Reels
      </h2>
  </div>
       ...
       z-11
        ...
        >
          {reelsData.map((reel, index) => (
            <Card
              key={index}
              className={`flex-shrink-0 w-[360px] max-[1500px]:w-[303px] max-[767px]:w-[250px] h-[368px] bg-[#0a66c2]/10 rounded-[20px] overflow-hidden border border-solid border-[#00000033] backdrop-blur-[22px] 
            ...
            >
              <CardContent data-reel-card className="p-0 relative h-full">
                <img
                  className="w-[360px] max-[1500px]:w-[303px] max-[767px]:w-[250px] h-[227px] rounded-t-[20px] object-cover"
                  src={reel.src}
                />
                <div className="absolute w-[320px] max-[1500px]:w-[266px] max-[767px]:w-[220px] h-[91px] top-[253px] left-[19px] max-[767px]:left-[14px] bg-[#ffffff]/10 rounded-[10px] border border-solid border-[#0000001a] backdrop-blur-[50px]">
