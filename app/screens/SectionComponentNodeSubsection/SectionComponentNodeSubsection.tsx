...
export default function SectionComponentNodeSubsection () {
  ...
  return (
      ...
      <div className="flex items-start   gap-[51.43px] max-[1100px]:gap-8 max-[10000px]:gap-[51px] max-[500px]:gap-5 max-[767px]:mb-[30px] mb-[56.19px] max-[1000px]:flex-wrap">
        <div className="flex flex-col w-[197.14px] items-start gap-10 max-[500px]:gap-4">
          ...
          <p className="font-Roboto font-normal text-black text-[14.3px] max-[767px]:text-[13px]  tracking-[0] leading-[22.9px]">
        ...
        <div className="flex flex-col w-[113.33px] items-center gap-[14.29px]">
          <h3 className="w-[94.29px] font-Roboto font-semibold text-black text-[19px] max-[767px]:text-[16px]  text-center tracking-[0] leading-[normal]">
            EXPLORE
          </h3>
          <nav className="flex flex-col w-[83.81px] items-center gap-[15.24px] max-[500px]:gap-3">
            {exploreLinks.map((link, index) => (
              <a
                key={index}
                href={link.href}
                className="font-Roboto font-normal text-black text-[16.2px] max-[767px]:text-[14px]  text-center tracking-[0.81px] leading-[normal] whitespace-nowrap hover:underline"
              >
                {link.label}
              </a>
            ))}
        ...
        <div className="flex flex-col items-center gap-[14.29px]">
          <h3 className="font-Roboto font-semibold text-black text-[19px] max-[767px]:text-[16px]  text-center tracking-[0] leading-[normal] whitespace-nowrap">
            RESOURCES
          </h3>
