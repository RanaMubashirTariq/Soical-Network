...
export default function Home() {
  return (
    <div className="w-full bg-white relative overflow-hidden">
        ...
        <img src="/3d-illsutration.png" className="w-[249px] h-[238px] absolute top-[592px] right-[-25.9px] object-cover max-[1100px]:w-[190px] max-[1100px]:h-[200px] max-[100px]:object-contain max-[1100px]:right-[-20px] max-[1000px]:top-[900px] max-[767px]:w-[150px] max-[767px]:h-[150px] max-[767px]:top-[650px] max-[350px]:top-[700px]" alt="" />
        <img src='/abstract-circal.png' className="w-[510px] h-[600px] max-[1100px]:h-[400px] max-[767px]:w-[350px] max-[767px]:h-[300px] max-[767px]:left-[-210px] max-[767px]:top-[2570px] max-[1000px]:top-[2200px] max-[500px]:top-[2350px] max-[400px]:top-[2300px] max-[500px]:left-[-230px] max-[330px]:left-[-210px]   absolute top-[2110px] left-[-310px] inset-0 z-0"/>
